...
public class JUnitNestedTest {
    ...
    class NestedTest1 {
        ...
        @BeforeEach
        public void beforeEach() {
            System.out.println("NestedTest1 before each is run ...");
        }

        @Test
        public void test2() {
            System.out.println("NestedTest1 test2 has run ...");
        }
        ...
        class NestedTest2 {
            ...
            @BeforeEach
            public void beforeEach() {
                System.out.println("NestedTest2 before each is run ...");
            }

            @Test
            public void test3() {
                System.out.println("NestedTest2 test3 has run ...");
            }
        }
    }
